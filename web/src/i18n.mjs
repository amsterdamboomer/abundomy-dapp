...
const EXTRA = {
  en: {
    ...
    APP_LEGACY_SUMMARY: 'Migration/dev: log in with user ID',
    APP_LEGACY_ID: 'User ID',
    APP_LEGACY_CONNECT: 'Connect (legacy)',
  ...
  ne: {
    ...
    APP_LEGACY_SUMMARY: 'Migratie/dev: inloggen met gebruikers-ID',
    APP_LEGACY_ID: 'Gebruikers-ID',
    APP_LEGACY_CONNECT: 'Verbinden (legacy)',
