...
const EXTRA = {
  en: {
    ...
    IMG_TITLE: 'PHOTO', IMG_INSTR: 'Choose and edit an image of your face', IMG_CANCEL: 'Cancel', IMG_RESET: 'Reset', IMG_ROTATE: 'Rotate', IMG_GET: 'Photo', IMG_ABORT: 'Abort', IMG_SNAP: 'Snap', IMG_CAPTION: 'Caption', IMG_USE: 'Use this photo',
  ...
  ne: {
    ...
    IMG_TITLE: 'FOTO', IMG_INSTR: 'Kies en bewerk een afbeelding van je gezicht', IMG_CANCEL: 'Annuleren', IMG_RESET: 'Reset', IMG_ROTATE: 'Draaien', IMG_GET: 'Foto', IMG_ABORT: 'Afbreken', IMG_SNAP: 'Klik', IMG_CAPTION: 'Opname', IMG_USE: 'Gebruik deze foto',
